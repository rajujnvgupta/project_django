...
class TeacherSignUpView(CreateView):
    ...
    #below code is happenning behind  the seen
    def queryset(self):
        return User.object.all()

    #adding extra context to return as user_type used in template
    ...
    def form_valid(self, form):
        ...
        #user.Profile.profile.set_image_to_default()
