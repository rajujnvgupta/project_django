# Generated by Django 2.1.7 on 2019-04-26 06:43
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Profile',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='profile_pic', serialize=False, to=settings.AUTH_USER_MODEL)),
                ('college', models.CharField(blank=True, max_length=255, null=True)),
                ('city', models.CharField(blank=True, max_length=255, null=True)),
                ('mobileNo', models.CharField(blank=True, max_length=255, null=True, unique=True)),
                ('profile', models.ImageField(blank=True, default='img/user.jpeg', null=True, upload_to='profile_picture')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('profile_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='classroom.Profile')),
            ],
            bases=(django.views.generic.edit.CreateView, 'classroom.profile'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='profile',
            name='state',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='states', to='classroom.State'),
        ),
    ]
